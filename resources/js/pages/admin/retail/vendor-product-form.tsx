        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    <a href="/admin/retail/vendor-products" className="rounded-md border p-2 hover:bg-accent"><ArrowLeft className="h-4 w-4" /></a>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                    <div className="rounded-lg border bg-card p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select value={form.vendor_id} onChange={(e) => setForm({ ...form, vendor_id: e.target.value })} className="w-full rounded-md border px-3 py-2" required>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" min="0" value={form.stock_quantity} onChange={(e) => setForm({ ...form, stock_quantity: e.target.value })} className="w-full rounded-md border px-3 py-2" required />
                            </div>
                        </div>
                        <div>
                    ...
                    <button type="submit" disabled={processing} className="w-full rounded-md bg-primary py-3 text-lg font-medium text-primary-foreground disabled:opacity-50">
